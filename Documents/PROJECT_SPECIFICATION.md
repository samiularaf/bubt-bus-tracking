...
_Note: "Favorite" is a personal convenience pin only (e.g., surfaces the bus higher on the Home list) — it does not restrict or assign the user to that bus. Users can still freely browse and track any bus, favorited or not, consistent with §3.1 ("No Bus Assignment for Users")._
