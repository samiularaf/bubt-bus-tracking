...
| 9 | *(pending)* | Socket.IO real-time system committed (`270ea4b`) — server-side verified with a genuine socket integration test (7/7); known limitation: sockets not yet JWT-authenticated, flagged for Phase 11 |
